          ...
          <div className="flex flex-col gap-5">
            <div className="form-control">
              ...
              <input
                ...
                className="px-[14px] py-[10px] border border-[#FDA29B] bg-[#FFF] rounded-lg focus:outline-none focus:ring-[#FEE4E2] focus:ring-4 placeholder:text-[#A9ACB5] "
            ...
            <p>
              ...
              <Link to="/signUp"><span className="text-[#377DFF] text-base font-medium">
                Sign Up
              </span></Link>
            </p>
          </div>
